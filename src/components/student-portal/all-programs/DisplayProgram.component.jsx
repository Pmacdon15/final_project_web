export default function DisplayProgram({ program, email, isMyProgramPage }) {
    ...
    return (
        <div 
            className={isMyProgramPage ? "flex flex-col w-full shadow-lg border-black items-center bg-white rounded-lg":
            ...
            onClick={isMyProgramPage ?  undefined :handleClick }           
        >
            ...
            {isMyProgramPage &&(
                // TODO: Add onClick event to register for program and reload page
